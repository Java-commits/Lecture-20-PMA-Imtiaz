...
//	public String createProject(Project project,@RequestParam List<Long> employeesId, Model model) {
//		
//		proRepo.save(project);
//		
//		Iterable<Employee> chosenEmployees = empoRepo.findAllById(employeesId);
//		
//		
...
//	}
	 ...
	 public String createProject(Project aProject,  @RequestParam List<Long> employees, @RequestParam String stage) {
	   ...
	   proRepo.save(aProject);
	   (empoRepo.findAllById(employees)).forEach((employee) -> {
